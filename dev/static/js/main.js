//для подключения нужно заменить // на //=
// также можно подключить библиотеку в таске sripts
// импортируем jQuery
...
$(function() {
  ...
  var nav_sub_items = $(
    ".nav-header__item--parent .nav-header__sub-list .nav-header__item"
  );
